...
# c.Session.username = u'nubagamma'
...
# draw.io gives following error '_xsrf' argument missing from POST
# suggested solution from https://github.com/nteract/hydrogen/issues/922
